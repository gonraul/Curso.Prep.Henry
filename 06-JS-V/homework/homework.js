...
function agregarStringInvertida() {
  ...
  // 'toni'.reverse() => 'inot'
  // Pista: Necesitarás usar "this" dentro de "reverse"    npm test JSV.test.js
...
// ---------------------------------------------------------------------------//
  ...
  //Ej: { 
    ...
    //   Apellido: 'Perez',
    //   Edad: 22,
    //   Domicilio: 'Saavedra 123'                         npm test JSV.test.js
    //  }
...
function crearInstanciaPersona(nombre, apellido, edad, dir) {
  ...
  //Devolver la nueva persona creada                npm test JSV.test.js
